...
#-----------------------------------
# NECESITO USAR LA INTERFAZ INICIAL POR EL MOMENTO PARA PODER SEGUIR DIBUJANDO LA DE LTABLERO
import interfaz_inicial as II
...
if j[2] == 'facil':
    ...
    print('ERROR AL OCNFIGURAR NIVEL')

print(configuracion)
preferencias = Preferencias(configuracion['filas'], configuracion['columnas'], configuracion['especiales'],
                            configuracion['nivel'])
...
if (archivo_partida.cargar_guardado()):
    ...
    interfaz = Dibujar(unTablero, preferencias, atril_jugador,j) #aca necesita un objeto ugador es sol ode prueba
    ...
    puntaje = 0
    puntaje_pc = 0
    interfaz = Dibujar(unTablero, preferencias, atril_jugador,j)
