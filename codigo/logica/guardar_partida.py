...
class Juego_Guardado:
    ...
    '''
    juego = []
    def __init__(self, ruta_guardado, tablero=None, jugador=None, atril=None, b_fichas=None, puntaje=None, puntaje_pc=None, tiempo_restante=None, pref=None, cant_cambiar=None):
